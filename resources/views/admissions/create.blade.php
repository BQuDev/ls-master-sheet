      ...
      <section class="panel panel-default">
         ...
         <div class="panel-body">
            <div class="form-group">
               ...
               <div class="col-sm-9">
               {!! Form::select('agent_type', $admission_source,'',['class'=>'chosen-select col-sm-4']);  !!}
         ...
         <div class="line line-dashed b-b line-lg pull-in"></div>
           ...
           <div class="panel-body">
                       ...
                       <div class="form-group">
                          ...
                          <div class="col-sm-9">
                             <select style="width:260px" class="chosen-select" id="tt_country" name="tt_country">
                                <optgroup label="Select One">
      ...
      <section class="panel panel-default">
         ...
         <div class="panel-body">
            ...
            <div class="form-group">
               ...
               <div class="col-sm-4">{!! Form::select('qualification_1', $education_qualifications,'',['class'=>'chosen-select']);  !!}</div>
...
<div id="qualification_container_2">
            <div class="form-group">
               ...
               <div class="col-sm-4">{!! Form::select('qualification_2', $education_qualifications,'',['class'=>'chosen-select']);  !!}</div>
...
<div id="qualification_container_3">
            <div class="form-group">
               ...
               <div class="col-sm-4">{!! Form::select('qualification_3', $education_qualifications,'',['class'=>'chosen-select']);  !!}</div>
