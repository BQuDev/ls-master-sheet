...
<td>{{ StudentSource::lastRecordBySAN($main_student->san)->app_date; }}</td>
<td>{{ StudentSource::lastRecordBySAN($main_student->san)->ams_date; }}</td>
<td>{{ ApplicationSource::getNameByID(StudentSource::lastRecordBySAN($main_student->san)->source); }}</td>
<td>
    @if(StudentSource::lastRecordBySAN($main_student->san)->admission_manager ==0)
    {{ 'Other' }}
    @else
    {{ ApplicationAdmissionManager::getNameByID(StudentSource::lastRecordBySAN($main_student->san)->admission_manager); }}
    @endif
</td>
<td>
 @if(StudentSource::lastRecordBySAN($main_student->san)->agent_lap ==0)
    {{ 'Other' }}
    @elseif(StudentSource::lastRecordBySAN($main_student->san)->admission_manager == 6)
{{ ApplicationLap::getNameByID(StudentSource::lastRecordBySAN($main_student->san)->agent_lap)   }}
    @else
{{ ApplicationAgent::getNameByID(StudentSource::lastRecordBySAN($main_student->san)->agent_lap)   }}
@endif
</td>
