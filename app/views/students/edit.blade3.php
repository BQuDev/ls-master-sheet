...
<div class="row">
  ...
  <tr>
    ...
    <td>{{ Form::select('qualification_2', $education_qualifications,'',['style'=>'width:150px !important','class'=>'chosen-select']);  }}</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>{{ Form::select('qualification_3', $education_qualifications,'',['class'=>'chosen-select','style'=>'width:150px !important']);  }}{{ Form::text('qualification_3_other', '',['placeholder'=>'Please Specify','class'=>'form-control']); }}</td>
  </tr>
  <tr>
