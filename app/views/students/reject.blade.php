...
<div class="row">
   <div class="col-sm-12">
     {{ Form::open(array('route' => array('students.destroy', $student->san), 'method' => 'delete','data-validate'=>'parsley')) }}
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  ...
  <tr>
    ...
    {{ StaticDataStatus::getNameByID($student_bqu_data->status); }}
      ...
      <section class="panel panel-default">
         <header class="panel-heading font-bold">Reason for rejection</header>
         <div class="panel-body">
         <table width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr>
    <td width="20%" align="right">{{ Form::label('notes', 'Notes', array('class' => 'control-label'));  }}</td>
    <td width="80%">{{ Form::textarea('notes','',['placeholder'=>'','class'=>'form-control']); }}</td>
  </tr>
  <tr>
    <td align="right"></td>
    <td>
     <div class="checkbox i-checks" style="margin: 20px;">
            <label>
  ...
  <tr>
    <td align="right"></td>
    <td>
   {{ Form::submit('Reject', array('class' => 'btn btn-s-md btn-danger')) }}
    </td>
  </tr>
