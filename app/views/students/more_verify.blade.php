...
<div class="row">
   <div class="col-sm-12">
      {{ Form::open(array('url' =>URL::to("/").'/students/verify',  'class'=>'form-horizontal','method' => 'post','data-validate'=>'parsley')) }}
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
 ...
 {{ Form::submit('Verified', array('class' => 'btn btn-s-md btn-primary')) }}
              </div>
              </section>
      {{ Form::close() }}
   </div>
