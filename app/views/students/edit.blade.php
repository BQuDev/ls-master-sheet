...
<div class="form-group">
         ...
         <div class="col-sm-9">{{ Form::text('san', $data_student->san ,['placeholder'=>'Student Application Number (SAN)','class'=>'form-control','data-required'=>'true','minlength'=>"5",'onBlur'=>'checkSanAvailability()']); }}<span id="san_available"></span><span style="color: red" id="san_not_available"> SAN is already in the database </span> </div>
      </div>
