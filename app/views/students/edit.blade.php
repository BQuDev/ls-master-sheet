                        ...
                        <div class="panel-body">
                           <div class="form-group">
                            ...
                            <div class="form-group">
                               ...
                               <div class="col-sm-9 ">
							{{  DB::table('application_admission_managers')->where('id', $studentSource->admission_manager)->pluck('name'); }}
                               </div>
                            </div>
                           <div class="form-group">
                              ...
                              <div class="col-sm-9">
								...
								@if ($studentSource->admission_manager == 6)
                        ...
                        <section class="panel panel-default">
                              ...
                              <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="form-inline">
                                       <div class="col-sm-1">{{ $student->initials_1 }}</div>

                                       <div class="col-sm-1">{{ $student->initials_2 }}</div>

                                       <div class="col-sm-1">{{ $student->initials_3 }}</div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-3">{{ $student->date_of_birth_date.'-'.$student->date_of_birth_month.'-'.$student->date_of_birth_year }}<div class="form-inline">
                                                    </div>
                                                </div>
                                    </div>
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                       ...
                                       {{ DB::table('static_nationalities')->where('id', $student->nationality)->pluck('name'); }}
                                    </div>
                                 </div>
                                 <div class="form-group">
                  ...
                  <div class="line line-dashed b-b line-lg pull-in"></div>
                    ...
                    <div class="panel-body">
                                ...
                                <div class="form-group">
                                   ...
                                   <div class="col-sm-9">
									  {{  DB::table('static_countries')->where('id', $ttStudentContactInformation->country)->pluck('name'); }}
                                   </div>
                                </div>
                                <div class="form-group">
                  ...
                  <div class="panel-body">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                             ...
                             {{  DB::table('static_countries')->where('id', $studentContactInformation->country)->pluck('name'); }}
